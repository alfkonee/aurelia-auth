...
export class Authentication {
  ...
  setRefreshToken(response) {
    ...
    if (!token && response) {
      token = this.config.refreshTokenRoot && response.content[this.config.refreshTokenRoot]
        ? response.content[this.config.refreshTokenRoot][this.config.refreshTokenName]
        : response.content[this.config.refreshTokenName];
    }
